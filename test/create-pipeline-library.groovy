...
GitSCMSource librarySource = new GitSCMSource("pipeline-library", "https://github.com/garethahealy/pipeline-library.git", "", "*", "", true)
...
config.setDefaultVersion("jenkinsfile-tests")
